...
const Footer = () => {
  return (
    <div className="pt-16 pb-16 bg-blue-950">
      <div className="w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 grid md:grid-cols-3 lg:grid-cols-4 gap-4">
        {/* 1st part */}
        <div>
          ...
          <p className="mt-4 text-gray-200 font-medium">
            ...
            magnam illum molestias aliquid quam nam accusantium mollitia.
          </p>
          {/* socials links */}
